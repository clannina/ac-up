...
export default function AcHome() {
  const [scheda, setScheda] = useState("spese"); // "spese" | "budget"
  ...
  return (
    <div className="min-h-screen pb-24 px-4 pt-6" style={{ background: T.paper, color: T.stone }}>
      ...
      <div className="flex gap-2 mb-4">
        <button
          onClick={() => setScheda("spese")}
          className="flex-1 py-2 rounded-2xl text-sm font-medium"
          style={scheda === "spese" ? { background: T.forest, color: "#fff" } : { background: "rgba(0,0,0,0.05)", color: T.stone }}
        >
          Spese
        </button>
        <button
          onClick={() => setScheda("budget")}
          className="flex-1 py-2 rounded-2xl text-sm font-medium"
          style={scheda === "budget" ? { background: T.forest, color: "#fff" } : { background: "rgba(0,0,0,0.05)", color: T.stone }}
        >
          Budget
        </button>
      </div>
